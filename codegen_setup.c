...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "WIPEOUT_XL_PROJECT_ROOT",
    .build_dir_env = "WIPEOUT_XL_BUILD_DIR",
    .force_setup_env = "WIPEOUT_XL_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/scus_943.51_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Wipeout_XL_Recompiled",
    .prepare_note =
